    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(blank=True, help_text="Une courte description affichée par exemple sur la page d'accueil", max_length=512, verbose_name='Courte description')),
                ('long_description', models.TextField(blank=True, help_text='Description potentiellement très longue affichée sur la page du streamer ou de la streameuse', verbose_name='Longue description')),
                ...
                ('user', models.OneToOneField(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Compte interne du streamer')),
            ],
        ),
    ]
